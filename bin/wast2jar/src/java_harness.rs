...
impl<'a, P: Display, W: Write, T: WatTranslator> JavaHarness<'a, P, W, T> {
    ...
    pub fn class_main_and_close(mut self, test_methods_count: usize) -> io::Result<()> {
        ...
        for (name, value) in [
            ...
            ("global_i32", "new org.wasm2jar.Global(666)"),
            ("global_i64", "new org.wasm2jar.Global(666L)"),
            ("global_f32", "new org.wasm2jar.Global(666f)"),
            ("global_f64", "new org.wasm2jar.Global(666d)"),
